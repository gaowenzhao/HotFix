...
public class FixDexUtil {
    ...
    public static boolean isGoingToFix(@NonNull Context context) {
        ...
        File fileDir = externalStorageDirectory != null ? externalStorageDirectory : new File(context.getFilesDir(), DEX_DIR);// data/data/包名/files/odex（这个可以任意位置）
    ...
    private static void doDexInject(Context appContext, HashSet<File> loadedDex) {
        ...
        try {
            ...
            for (File dex : loadedDex) {
                // 2.加载指定的修复的dex文件的Loader，每遍历一次插拔一次
